...
# NOTE: Ship_mode trim, Customer_name trim, aur Region case-standardize
# yahan SQL mein nahi kiye — ye Power Query mein one-click Format 
# transformations se honge (Trim / Capitalize Each Word), jaisa 
# mixed date format bhi Power Query mein handle hua tha, SQL mein nahi.
