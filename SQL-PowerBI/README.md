...
## Step 7: Power BI Data Model
- Connected Power BI to MySQL using Get Data, and imported the cleaned `superstore_sales` table.
- Built a star schema — Orders as the fact table, connected to Date, Customer, Product, and Location dimension tables.
...
## Step 8: Power Query
Power Query was used only for minor data preparation. All major data cleaning and business logic were already handled in SQL:
