...
# Step 3, Point 4: Standardize Text (Sub_category spelling fix)
set sql_safe_updates = 0;
update superstore_sales set Sub_category = 'Accessories' where Sub_category = 'Accessoriess';
update superstore_sales set Sub_category = 'Appliances' where Sub_category = 'Appliancess';
update superstore_sales set Sub_category = 'Bookcases' where Sub_category = 'Bookcasess';
update superstore_sales set Sub_category = 'Furnishings' where Sub_category = 'Furnishingss';
update superstore_sales set Sub_category = 'Machines' where Sub_category = 'Machiness';
update superstore_sales set Sub_category = 'Storage' where Sub_category = 'Storagee';
set sql_safe_updates = 1;
...
select * from superstore_sales where sales<0 
or Quantity<=0 or Discount <0 or discount>1;
